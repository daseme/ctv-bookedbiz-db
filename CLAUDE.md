...
- Nord-themed CSS, Chart.js for visualizations
- Blueprints registered in `src/web/blueprints.py` via `initialize_blueprints()` — NEVER in `app.py`
- Customer table uses `normalized_name` (NOT `customer_name`); agency table uses `agency_name`
