...
def compare_with_your_documented_results():
    ...
    print(f"   Base Query Difference: ${base_diff:,.2f} {'✅' if base_diff < 1.0 else '❌'}")
    print(f"   Direct Response Difference: ${dr_diff:,.2f} {'✅' if dr_diff < 1.0 else '❌'}")
    print(f"   Total Difference: ${total_diff:,.2f} {'✅' if total_diff < 1.0 else '❌'}")
