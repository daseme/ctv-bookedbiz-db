...
def run_complete_reconciliation_test(year="2024"):
    ...
    try:
        ...
        print(
            f"${individual_revenue:>12,.2f} {individual_spots:>6,} {individual_pct:>6.1f}% ✅"
        )
        ...
        print(
            f"${chinese_result.revenue:>12,.2f} {chinese_result.spot_count:>6,} {chinese_pct:>6.1f}% ✅"
        )
        ...
        print(
            f"${multi_result.revenue:>12,.2f} {multi_result.spot_count:>6,} {multi_pct:>6.1f}% ✅"
        )
        ...
        print(
            f"${dr_result.revenue:>12,.2f} {dr_result.spot_count:>6,} {dr_pct:>6.1f}% ✅"
        )
        ...
        print(
            f"${other_result.revenue:>12,.2f} {other_result.spot_count:>6,} {other_pct:>6.1f}% ✅"
        )
        ...
        print(
            f"${shopping_result.revenue:>12,.2f} {shopping_result.spot_count:>6,} {shopping_pct:>6.1f}% ✅"
        )
        ...
        print(
            f"${prd_result.revenue:>12,.2f} {prd_result.spot_count:>6,} {prd_pct:>6.1f}% ✅"
        )
        ...
        print(
            f"${svc_result.revenue:>12,.2f} {svc_result.spot_count:>6,} {svc_pct:>6.1f}% ✅"
        )
        ...
        print("-" * 70)
        print(
            f"{'CATEGORY TOTAL':<30} ${category_total_revenue:>12,.2f} {category_total_spots:>6,} {'100.0%':<8}"
        )
        print(
            f"{'DATABASE TOTAL':<30} ${total_result.revenue:>12,.2f} {total_result.spot_count:>6,} {'100.0%':<8}"
        )
        ...
        print("-" * 70)
        print(
            f"{'Revenue':<25} ${category_total_revenue:>12,.2f} ${total_result.revenue:>12,.2f} ${difference:>12,.2f} {'✅' if difference < 1.0 else '❌'}"
        )
        print(
            f"{'Spots':<25} {category_total_spots:>12,} {total_result.spot_count:>12,} {spot_difference:>12,} {'✅' if spot_difference == 0 else '❌'}"
        )

        # Calculate error percentage
        error_pct = (
            (difference / total_result.revenue) * 100 if total_result.revenue > 0 else 0
        )
        ...
        print(
            f"   • Cross-Audience Revenue: ${chinese_result.revenue + multi_result.revenue:,.2f} ({(chinese_result.revenue + multi_result.revenue) / total_result.revenue * 100:.1f}%)"
        )
        print(
