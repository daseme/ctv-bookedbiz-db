...
from web.app import (
    ...
    get_quarterly_performance_data,
    get_ae_performance_data,
    get_sector_performance_data,
)
...
class TestRoutes:
    ...
    def test_report2_route_success(
        self, mock_get_ae, mock_get_quarterly, client, mock_quarterly_data, mock_ae_data
    ):
    ...
    @patch("web.app.get_quarterly_performance_data")
    @patch("web.app.get_ae_performance_data")
    def test_report3_route_success(
        self, mock_get_ae, mock_get_quarterly, client, mock_quarterly_data, mock_ae_data
    ):
