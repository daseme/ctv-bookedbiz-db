    ...
    def test_file_locking_prevents_corruption(self):
        ...
        def write_large_data(thread_id):
            ...
            large_update = {
                ...
                "notes": f"Large update from thread {thread_id} "
                + "x" * 1000,  # Large text
            }
...
class TestDataSourceConfiguration(unittest.TestCase):
    ...
    def test_json_only_source(self):
        ...
        service = PipelineService(
            data_path=self.temp_dir, data_source=DataSourceType.JSON_ONLY
        )
    ...
    def test_db_only_source(self):
        ...
        service = PipelineService(
            db_connection=self.db_connection, data_source=DataSourceType.DB_ONLY
        )
