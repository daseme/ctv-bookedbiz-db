...
from src.models.report_data import (
    ReportFilters, MonthlyRevenueReportData, CustomerMonthlyRow,
    AEPerformanceReportData, QuarterlyPerformanceReportData
)
...
class TestReportDataService:
    ...
    def test_customer_monthly_revenue_query_building(self):
        ...
        self.service._get_customer_monthly_revenue(self.mock_db_connection, 2025, filters)
    ...
    def test_customer_monthly_row_creation(self):
        ...
        result = self.service._get_customer_monthly_revenue(self.mock_db_connection, 2025, filters)
    ...
    def _setup_monthly_revenue_mocks(self):
        ...
        # Set up execute to return different cursors for different queries
        cursors = [revenue_cursor, years_cursor, ae_cursor, types_cursor, closure_cursor]
