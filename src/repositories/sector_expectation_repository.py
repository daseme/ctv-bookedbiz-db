...
class SectorExpectationRepository(BaseService):
    ...
    def save_expectations(
        ...
        with self.safe_transaction() as conn:
            ...
            logger.info(
                f"Saved {saved_count} sector expectations for {ae_name} {year}"
            )
