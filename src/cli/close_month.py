        ...
        if args.list:
            ...
            try:
                ...
                if success:
                    ...
                    print(
                        f"  • View all closed months: uv run python src/cli/close_month.py --list"
                    )
                else:
            ...
            print(f"\nQuick commands:")
            print(
                f"  List closed months:    uv run python src/cli/close_month.py --list"
            )
            print(
                f"  Check month status:    uv run python src/cli/close_month.py --status 'May-25'"
            )
            print(
                f"  Close a month:         uv run python src/cli/close_month.py 'May-25' --closed-by 'Kurt'"
            )
