    ...
    try:
        ...
        if hasattr(pipeline_service, 'validate_data_consistency'):
            ...
            health_info['consistency_check'] = {
                ...
                'conflict_details': consistency_result.conflicts[:5]  # First 5 conflicts for brevity
            }
...
def budget_health():
    ...
    try:
        ...
        try:
            ...
            health_info['basic_operations'] = {
                'get_monthly_budget': f'error: {str(e)}'
            }
        ...
        status_code = 200 if status == 'healthy' else (206 if status == 'warning' else 503)
...
def validate_data_consistency():
    ...
    try:
        ...
        validation_results['status'] = 'consistent' if all_consistent else 'inconsistent'
        ...
        try:
            ...
            if hasattr(pipeline_service, 'force_consistency_repair'):
                ...
                repair_results['services']['pipeline'] = {
                    ...
                    'conflicts_resolved': len(result.conflicts) if not result.is_consistent else 0,
                    'recommendations': result.recommendations
                }
                
                if not result.is_consistent:
                    repair_results['warnings'].append('Pipeline consistency repair completed but issues remain')
        except Exception as e:
            repair_results['services']['pipeline'] = {
                'error': str(e),
                'repaired': False
...
def emergency_repair():
    ...
    try:
        ...
        try:
            ...
            recovery_result['pipeline_repair'] = {
                'success': False,
                'error': str(e)
            }
        ...
        logger.warning(f"Emergency repair completed with status: {recovery_result['success']}")
...
def system_metrics():
    ...
    try:
        ...
        try:
            ...
            if hasattr(pipeline_service, 'get_data_source_info'):
                ...
                metrics['pipeline'] = {
                    ...
                    'consistency_status': info.get('consistency_status', {}).get('is_consistent', 'unknown')
                }
        except Exception as e:
        ...
        return create_success_response({
            ...
            'basic_info': {
                'services': len(get_container().list_services())
            }
        })
    except Exception as e:
