...
def budget_management():
    ...
    try:
        ...
        return render_template(
            "error_500.html", message="Error loading budget management"
        ), 500
...
def upload_budget():
    ...
    try:
        ...
        logger.info(
            f"Budget uploaded successfully: version_id={version_id}, year={data['year']}"
        )

        return create_success_response(
            {"version_id": version_id, "message": "Budget uploaded successfully"}
        )
...
def initialize_sample_data():
    ...
    try:
        ...
        if initialized:
            ...
            return create_success_response(
                {"message": "Budget data already exists", "initialized": False}
            )
