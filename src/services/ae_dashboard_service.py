...
class AEDashboardService(BaseService):
    ...
    def _get_customer_yoy_performance(
        ...
        ae_condition = ""
        params = [year_suffix, prior_year_suffix, year_suffix, prior_year_suffix, year_suffix, prior_year_suffix]
        if ae_filter:
        ...
        for row in cursor.fetchall():
            customer_id, customer_name, sector, ae, ytd_2024, ytd_2023, q4_2024, q4_2023, first_year = row
            
            # Calculate variance
            variance_dollars = ytd_2024 - ytd_2023
            variance_pct = (variance_dollars / ytd_2023 * 100) if ytd_2023 > 0 else (100 if ytd_2024 > 0 else 0)
            ...
            customers.append(CustomerYoYPerformance(
    ...
    def _determine_pattern(self, ytd_2024: float, ytd_2023: float, q4_2024: float, q4_2023: float) -> str:
    ...
    def _calculate_overall_metrics(
        ...
        total_variance_pct = (total_variance / total_ytd_2023 * 100) if total_ytd_2023 > 0 else 0
        ...
        # Retention rate
        retention_rate = ((active_2023 - len(lost_customers)) / active_2023 * 100) if active_2023 > 0 else 0
        ...
        new_customer_pct = (new_customer_revenue / total_ytd_2024 * 100) if total_ytd_2024 > 0 else 0
