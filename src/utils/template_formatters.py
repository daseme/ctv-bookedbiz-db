...
def _create_customer_breakdown_data(revenue_data: List[Dict[str, Any]]) -> Dict[str, Any]:
...
def calculate_statistics(revenue_data: List[Dict[str, Any]]) -> Dict[str, Any]:
    ...
    return {
        ...
        'avg_customer_revenue': total_revenue / len(revenue_data) if revenue_data else 0
    }
