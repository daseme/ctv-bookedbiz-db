=== SCHEMA FOR DATABASE: data/database/production.db ===
...
COLUMNS:
  ...
  source_file: TEXT NOT NULL
  broadcast_months_affected: TEXT
  records_imported: INTEGER DEFAULT 0
  records_deleted: INTEGER DEFAULT 0
...
COLUMNS:
  budget_data_id: INTEGER (PRIMARY KEY)
  version_id: INTEGER NOT NULL
  ae_name: TEXT NOT NULL
  year: INTEGER NOT NULL
  quarter: INTEGER NOT NULL
...
idx_spots_ae_broadcast_month_revenue:
...
idx_spots_ae_broadcast_covering:
...
spots_with_language_blocks_enhanced:
...
WHERE (s.revenue_type != 'Trade' OR s.revenue_type IS NULL);
language_block_revenue_analysis:
...
language_block_revenue_summary:
...
TRIGGERS:
---------
detect_market_assignment_collision:
